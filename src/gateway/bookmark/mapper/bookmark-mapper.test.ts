...
describe("BookmarkMapper", () => {
  ...
  describe("toDomain", () => {
    it("should convert valid BookmarkDto to Bookmark domain entity", () => {
      fc.assert(
    ...
    it("should return error for invalid BookmarkDto", () => {
      const invalidDto = {
        id: "",
        title: "",
        url: "invalid-url",
  ...
  describe("toDto", () => {
    it("should convert Bookmark domain entity to BookmarkDto", () => {
      const validDto = {
